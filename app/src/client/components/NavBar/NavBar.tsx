...
import { UserMenuItems } from '../../pages/user/UserMenuItems';
          ...
          >
            <div className='flex items-center gap-6'>
              <WaspRouterLink
                ...
                aria-label={`${branding.name || 'Your SaaS'} home`}
              >
                <NavLogo isScrolled={isScrolled} logoUrl={branding.logoUrl} />
                <span
          ...
          <SheetHeader>
            <SheetTitle className='flex items-center gap-2'>
              <WaspRouterLink to={routes.LandingPageRoute.to} className='flex items-center gap-2'>
                <span className='sr-only'>{branding.name || 'Your SaaS'}</span>
                <NavLogo isScrolled={false} logoUrl={branding.logoUrl} />
                <span 
...
const NavLogo = ({ isScrolled, logoUrl }: { isScrolled: boolean; logoUrl?: string | null }) => (
  <img
