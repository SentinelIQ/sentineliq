import { getCustomerPortalUrl, getCurrentWorkspace, useQuery } from 'wasp/client/operations';
import { Link as WaspRouterLink, routes } from 'wasp/client/router';
import type { User } from 'wasp/entities';
import { Button } from '../../components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '../../components/ui/card';
import { Separator } from '../../components/ui/separator';
import { SubscriptionStatus, parsePaymentPlanId, prettyPaymentPlanName } from '../../../core/payment/plans';
          ...
          <div className='space-y-0'>
            ...
            <div className='py-4 px-6'>
              <div className='grid grid-cols-1 sm:grid-cols-3 sm:gap-4'>
                ...
                <UserCurrentPaymentPlan
                  subscriptionStatus={workspace?.subscriptionStatus as SubscriptionStatus}
                  subscriptionPlan={workspace?.subscriptionPlan}
                  datePaid={workspace?.datePaid}
            ...
            <div className='py-4 px-6'>
              <div className='grid grid-cols-1 sm:grid-cols-3 sm:gap-4'>
                ...
                <dd className='mt-1 sm:col-span-2 sm:mt-0 flex items-center justify-between'>
                  ...
                  <WaspRouterLink to={routes.TwoFactorAuthRoute.to}>
