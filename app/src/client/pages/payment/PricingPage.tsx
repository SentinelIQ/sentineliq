...
import { generateCheckoutSession, getCustomerPortalUrl, getCurrentWorkspace, useQuery } from 'wasp/client/operations';
import { Alert, AlertDescription } from '../../components/ui/alert';
import { Button } from '../../components/ui/button';
import { Card, CardContent, CardFooter, CardTitle } from '../../components/ui/card';
import { cn } from '../../../lib/utils';
import { PaymentPlanId, paymentPlans, prettyPaymentPlanName, SubscriptionStatus } from '../../../core/payment/plans';
...
const PricingPage = () => {
  ...
  const isUserSubscribed =
    !!workspace && !!workspace.subscriptionStatus && workspace.subscriptionStatus !== SubscriptionStatus.Deleted;
    ...
    <div className='py-10 lg:mt-10'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <p className='mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-muted-foreground'>
          Stripe integration with secure checkout and subscription management. Just add your Product IDs! Try it
